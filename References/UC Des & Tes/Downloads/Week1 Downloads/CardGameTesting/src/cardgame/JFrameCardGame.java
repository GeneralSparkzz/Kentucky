...
public class JFrameCardGame extends javax.swing.JFrame {
    ...
    public DefaultListModel getCards() {
        return cards;
    }

    public void setCards(DefaultListModel cards) {
        this.cards = cards;
    }
    ...
    public void setBtnDeal(JButton btnDeal) {
    ...
    public void setBtnHigh(JButton btnHigh) {
    ...
    public void setBtnLow(JButton btnLow) {
        this.btnLow = btnLow;
    }
    ...
    public JList getLstCards() {
        return lstCards;
    }

    public void setLstCards(JList lstCards) {
